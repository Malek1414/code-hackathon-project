...
#ifndef FOLLOWCAM_SWIFT_H
#define FOLLOWCAM_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="FollowCam",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// Owns the capture session, hands every frame to <code>onFrame</code>, and records
/// H.264 video to a temp file that is saved to Photos on stop.
SWIFT_CLASS("_TtC9FollowCam13CameraManager")
...
SWIFT_CLASS("_TtC9FollowCam16HeartRateMonitor")
...
SWIFT_CLASS("_TtC9FollowCam20WhoopAuthCoordinator")
@interface WhoopAuthCoordinator : NSObject <ASWebAuthenticationPresentationContextProviding>
