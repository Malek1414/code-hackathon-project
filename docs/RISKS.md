...
| pitch and deck | pitch/video/: 01_prototype_10s, 02_ingame_20s, 03_combined_30s, analytics_segment_37s (Malek's video is in the repo). pitch/deck/index.html: 5 slides, no placeholders left, references ../../out/pitch/analytics_side_by_side.mp4 (the 12:44 dev60 cut, 20 s) and ../../viz/followcam_pod_v4_poster.png; newer out/pitch/analytics_segment.mp4 (15:00) is not used by the deck |
